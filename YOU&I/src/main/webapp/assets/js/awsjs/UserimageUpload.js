	...
	const putFile = file => {
		...
		const upload = new AWS.S3.ManagedUpload({
			params: {
				...
				Key: 'profile/Userprofile/' + fileS3Root + randomRoot + '_' + year + '_' + month + '_' + day + '_' + file.name,
				Body: file,
				ACL: "public-read"
			}
		});
		...
		return ['profile/Userprofile/' + fileS3Root + randomRoot + '_' + year + '_' + month + '_' + day + '_' + file.name, file.name, year + '_' + month + '_' + day]
	};
	function guid() {
		function s4() {
